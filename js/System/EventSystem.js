  ...
  loadSavedProfilesList() {
    ...
    setTimeout(() => {
      ...
      if (!this.profileManager) {
        container.innerHTML =
          '<p style="color:#ccc;text-align:center;">Sistema de perfis não disponível</p>';
        return;
      }
      ...
      profiles.forEach((profile) => {
        ...
        const isCurrent =
          this.currentProfile && this.currentProfile.name === profile.name;
...
// ========== FALLBACK DE INICIALIZAÇÃO// Fallback de inicialização
...
setTimeout(() => {
  ...
  const screensToRegister = [
    {
      id: "profile-creation",
      instance: window.profileCreationScreen,
      name: "ProfileCreationScreen",
    },
    {
      id: "profile-selection",
      instance: window.profileSelectionScreen,
      name: "ProfileSelectionScreen",
    },
    {
      id: "main-menu",
      instance: window.mainMenuScreen,
      name: "MainMenuScreen",
    },
  ...
  console.log(
    "📋 Telas registradas no EventSystem:",
    Object.keys(window.eventSystem.screens),
  );
...
if (typeof window !== "undefined") {
  ...
  // Inicializado como window.eventSystem
}
